...
//cannot be merged with the normal getmanifest, due to monochrome also outputting the manifest for different silicon beings!

/obj/effect/datacore/proc/ai_get_manifest(OOC)
	var/list/heads = new()
	var/list/sec = new()
	var/list/eng = new()
	var/list/med = new()
	...
	<head><style>
		...
		.manifest td, th {border:1px solid; padding:.25eml;}
