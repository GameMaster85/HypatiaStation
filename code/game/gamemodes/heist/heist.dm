...
/datum/game_mode/proc/greet_vox(var/datum/mind/raider)
	...
	raider.current << "\blue The Vox are a race of cunning, sharp-eyed nomadic raiders and traders endemic to the frontier and much of the unexplored galaxy. You and the crew have come to the Hypatia for plunder, trade or both."
